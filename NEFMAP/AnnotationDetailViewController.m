...
-(void) viewDidLoad
{
    ...
    NSArray * getAddressDescription =  [[dataController getAddressDescription:dataController.strProjectID] retain];
    
    for (NSDictionary *d in getAddressDescription)
    {
        NSString * name =    [d objectForKey:@"ProjectName"];
    ...
    [getAddressDescription release];
    
    myProjectHeader.textAlignment = UIBaselineAdjustmentAlignCenters;
    ...
    myProjectDetailScroll.text = [[dataController getAddress:dataController.strProjectID] retain];
    ...
    UIBarButtonItem * buttonFullScreen = [[UIBarButtonItem alloc] initWithTitle:@"Zoom" style:UIBarButtonSystemItemAction target:self action:@selector(buttonPressedFullScreen:)];
    ...
    UIBarButtonItem * buttonCamera = [[UIBarButtonItem alloc] initWithTitle:@"Camera" style:UIBarButtonSystemItemAction target:self action:@selector(buttonPressedCamera:)];
    ...
    UIBarButtonItem * buttonPhotoGallery = [[UIBarButtonItem alloc] initWithTitle:@"Photos" style:UIBarButtonSystemItemAction target:self action:@selector(buttonPressedPhotoGallery:)];
    ...
    UIBarButtonItem * buttonGoto = [[UIBarButtonItem alloc] initWithTitle:@"Directions" style:UIBarButtonSystemItemAction target:self action:@selector(directionsToHere)];
...
- (NSMutableArray *) imageData 
{
    ...
    NSArray * tempDirectoryFiles = [[[NSArray alloc] initWithArray: [myTempFileManager contentsOfDirectoryAtPath:path error:nil]] autorelease];
    ...
    return (NSMutableArray *) tempDirectoryFiles;
}
...
- (UIImage *) imageAtIndex: (NSUInteger) index 
{
    ...
    NSString * path = [NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@/%@", dataController.strProjectID, imageName];
